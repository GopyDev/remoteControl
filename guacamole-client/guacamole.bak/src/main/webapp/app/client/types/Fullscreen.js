angular.module('client').factory('Fullscreen', ['$document', '$rootScope',
    function defineManagedDisplay($document, $rootScope) {
...
angular.module('client').directive('fullscreen', ['Fullscreen', function(Fullscreen) {
      return {
